...
public class EncodingService {
    ...
    public String encode(String input, String folder, String audioCodecConfigId, String videoCodecConfig) {
        try {
            ...
            return bitmovin.startEncoding(encodingId, manifestId);
        } catch (Exception e) {
            log.error("DEBUG", e);
            return null;
        }
